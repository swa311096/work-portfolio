...
I keep a few tailored versions by focus area. Each link opens the PDF in a **new browser tab** using the built-in viewer (preview). From there you can read online or use your browser’s download / print controls if you want a file copy.

| Focus | Open |
|---|---|
| Ads | <a href="{{ '/assets/resumes/swapnil-kumar-resume-ads.pdf' | relative_url }}" target="_blank" rel="noopener noreferrer">Swapnil Kumar — Ads</a> |
