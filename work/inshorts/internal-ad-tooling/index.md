...
**Objective:** Scale internal ad tooling so brand, reporter, and user-generated campaigns could be distributed, measured, and reconciled on one stack—without breaking geographic rules or impression commitments.
...
<figure class="internal-ad-tooling-figure">
  ...
  <figcaption>Consumer-facing formats. The product explained each unit with a simple phone mockup—e.g. Aston Band sits below the content cards, while in-feed video sits among the cards. That matched how we reasoned about slots when building distribution and measurement.</figcaption>
</figure>
...
<figure class="internal-ad-tooling-figure">
  ...
  <figcaption>Internal booking—location and campaign inputs. Ops captured ad type, advertiser details, and geographic scope via “Choose Ad location” (the tiers that drive the inventory pool). Service period and billing flags sat alongside—the inputs that fed targeting, pacing, and downstream impression accounting.</figcaption>
</figure>
...
<h3 class="article-h3-compact" id="what-we-counted">What we counted</h3>

- Impressions first—the main signal for delivery and, for UGA, for staying within sold volume.

<h3 class="article-h3-compact" id="how-we-validated">How we validated</h3>
...
<h3 class="article-h3-compact" id="what-we-deferred">What we deferred</h3>

- Click tracking was planned as a follow-on; we did not ship it in this phase.

<h3 class="article-h3-compact" id="what-we-showed-alongside-ads">What we showed alongside ads</h3>
